...
-- Migration for marketplace listings and user hoard functionality
...
CREATE TABLE IF NOT EXISTS hoard_items (
...
CREATE INDEX IF NOT EXISTS idx_hoard_items_user_id ON hoard_items(user_id);
CREATE INDEX IF NOT EXISTS idx_hoard_items_content_type ON hoard_items(content_type);
CREATE INDEX IF NOT EXISTS idx_hoard_items_novel_id ON hoard_items(novel_id);
CREATE INDEX IF NOT EXISTS idx_hoard_items_manga_id ON hoard_items(manga_id);
CREATE INDEX IF NOT EXISTS idx_hoard_items_status ON hoard_items(status);
CREATE INDEX IF NOT EXISTS idx_hoard_items_added_at ON hoard_items(added_at);

CREATE INDEX IF NOT EXISTS idx_marketplace_listings_hoard_item ON marketplace_listings(hoard_item_id);
